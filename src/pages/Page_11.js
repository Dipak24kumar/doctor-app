        ...
        <div className="accordion card-container" id="accordionExample">
          <div className="card">
            <div className="card-header" id="headingOne">
              <button className="btn-block default-btn mb-3" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          ...
          <div className="card">
            <div className="card-header" id="headingTwo">
              <button className="btn-block default-btn mb-3" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <div className="card ">
            <div className="card-header" id="headingThree">
              <button className="btn-block default-btn mb-3" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
          ...
          <div className="card ">
            <div className="card-header" id="headingFour">
              <button className="btn-block default-btn mb-3" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
          ...
          <div className="card ">
            <div className="card-header" id="headingFive">
              <button className="btn-block default-btn mb-3" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
          ...
          <div className="card ">
            <div className="card-header" id="headingSix">
              <button className="btn-block default-btn mb-3" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
          ...
          <div className="card mb-5">
            <div className="card-header" id="headingSeven">
              <button className="btn-block default-btn mb-3" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">
